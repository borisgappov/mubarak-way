...
|------------- | ------------- | -------------|
| [**createLessonApiV1LearningLessonsPost**](LearningApi.md#createlessonapiv1learninglessonspost) | **POST** /api/v1/learning/lessons | Create Lesson |
| [**createProgressApiV1LearningProgressPost**](LearningApi.md#createprogressapiv1learningprogresspost) | **POST** /api/v1/learning/progress | Create Progress |
| [**createStepApiV1LearningStepsPost**](LearningApi.md#createstepapiv1learningstepspost) | **POST** /api/v1/learning/steps | Create Step |
| [**createUnitApiV1LearningUnitsPost**](LearningApi.md#createunitapiv1learningunitspost) | **POST** /api/v1/learning/units | Create Unit |
| [**deleteUnitApiV1LearningUnitsUnitIdDelete**](LearningApi.md#deleteunitapiv1learningunitsunitiddelete) | **DELETE** /api/v1/learning/units/{unit_id} | Delete Unit |
| [**generateQuizApiV1LearningQuizUnitIdPost**](LearningApi.md#generatequizapiv1learningquizunitidpost) | **POST** /api/v1/learning/quiz/{unit_id} | Generate Quiz |
| [**getLessonApiV1LearningLessonsLessonIdGet**](LearningApi.md#getlessonapiv1learninglessonslessonidget) | **GET** /api/v1/learning/lessons/{lesson_id} | Get Lesson |
| [**getLessonProgressApiV1LearningProgressLessonLessonIdGet**](LearningApi.md#getlessonprogressapiv1learningprogresslessonlessonidget) | **GET** /api/v1/learning/progress/lesson/{lesson_id} | Get Lesson Progress |
| [**getLessonWithStepsApiV1LearningLessonsLessonIdWithStepsGet**](LearningApi.md#getlessonwithstepsapiv1learninglessonslessonidwithstepsget) | **GET** /api/v1/learning/lessons/{lesson_id}/with-steps | Get Lesson With Steps |
| [**getLessonsByUnitApiV1LearningUnitsUnitIdLessonsGet**](LearningApi.md#getlessonsbyunitapiv1learningunitsunitidlessonsget) | **GET** /api/v1/learning/units/{unit_id}/lessons | Get Lessons By Unit |
| [**getRandomUnitApiV1LearningUnitsRandomGet**](LearningApi.md#getrandomunitapiv1learningunitsrandomget) | **GET** /api/v1/learning/units/random | Get Random Unit |
| [**getRecommendedApiV1LearningRecommendedGet**](LearningApi.md#getrecommendedapiv1learningrecommendedget) | **GET** /api/v1/learning/recommended | Get Recommended |
| [**getRecommendedUnitsApiV1LearningRecommendedUserUserIdGet**](LearningApi.md#getrecommendedunitsapiv1learningrecommendeduseruseridget) | **GET** /api/v1/learning/recommended/user/{user_id} | Get Recommended Units |
| [**getStatsApiV1LearningStatsGet**](LearningApi.md#getstatsapiv1learningstatsget) | **GET** /api/v1/learning/stats | Get Stats |
| [**getStepApiV1LearningStepsStepIdGet**](LearningApi.md#getstepapiv1learningstepsstepidget) | **GET** /api/v1/learning/steps/{step_id} | Get Step |
| [**getStepsByLessonApiV1LearningLessonsLessonIdStepsGet**](LearningApi.md#getstepsbylessonapiv1learninglessonslessonidstepsget) | **GET** /api/v1/learning/lessons/{lesson_id}/steps | Get Steps By Lesson |
| [**getUnitApiV1LearningUnitsUnitIdGet**](LearningApi.md#getunitapiv1learningunitsunitidget) | **GET** /api/v1/learning/units/{unit_id} | Get Unit |
| [**getUnitByCodeApiV1LearningUnitsCodeUnitCodeGet**](LearningApi.md#getunitbycodeapiv1learningunitscodeunitcodeget) | **GET** /api/v1/learning/units/code/{unit_code} | Get Unit By Code |
| [**getUnitProgressApiV1LearningProgressUnitUnitIdGet**](LearningApi.md#getunitprogressapiv1learningprogressunitunitidget) | **GET** /api/v1/learning/progress/unit/{unit_id} | Get Unit Progress |
| [**getUnitsApiV1LearningUnitsGet**](LearningApi.md#getunitsapiv1learningunitsget) | **GET** /api/v1/learning/units | Get Units |
| [**getUnitsByCategoryApiV1LearningUnitsCategoryCategoryGet**](LearningApi.md#getunitsbycategoryapiv1learningunitscategorycategoryget) | **GET** /api/v1/learning/units/category/{category} | Get Units By Category |
| [**getUnitsByDifficultyApiV1LearningUnitsDifficultyDifficultyLevelGet**](LearningApi.md#getunitsbydifficultyapiv1learningunitsdifficultydifficultylevelget) | **GET** /api/v1/learning/units/difficulty/{difficulty_level} | Get Units By Difficulty |
| [**getUnitsByTypeApiV1LearningUnitsTypeUnitTypeGet**](LearningApi.md#getunitsbytypeapiv1learningunitstypeunittypeget) | **GET** /api/v1/learning/units/type/{unit_type} | Get Units By Type |
| [**getUserProgressApiV1LearningProgressUserUserIdGet**](LearningApi.md#getuserprogressapiv1learningprogressuseruseridget) | **GET** /api/v1/learning/progress/user/{user_id} | Get User Progress |
| [**getUserStatsApiV1LearningStatsUserUserIdGet**](LearningApi.md#getuserstatsapiv1learningstatsuseruseridget) | **GET** /api/v1/learning/stats/user/{user_id} | Get User Stats |
| [**healthCheckApiV1LearningHealthGet**](LearningApi.md#healthcheckapiv1learninghealthget) | **GET** /api/v1/learning/health | Health Check |
| [**searchUnitsApiV1LearningSearchGet**](LearningApi.md#searchunitsapiv1learningsearchget) | **GET** /api/v1/learning/search | Search Units |
| [**updateLessonApiV1LearningLessonsLessonIdPut**](LearningApi.md#updatelessonapiv1learninglessonslessonidput) | **PUT** /api/v1/learning/lessons/{lesson_id} | Update Lesson |
| [**updateProgressApiV1LearningProgressProgressIdPut**](LearningApi.md#updateprogressapiv1learningprogressprogressidput) | **PUT** /api/v1/learning/progress/{progress_id} | Update Progress |
| [**updateStepApiV1LearningStepsStepIdPut**](LearningApi.md#updatestepapiv1learningstepsstepidput) | **PUT** /api/v1/learning/steps/{step_id} | Update Step |
| [**updateUnitApiV1LearningUnitsUnitIdPut**](LearningApi.md#updateunitapiv1learningunitsunitidput) | **PUT** /api/v1/learning/units/{unit_id} | Update Unit |
| [**upsertProgressApiV1LearningProgressUpsertPost**](LearningApi.md#upsertprogressapiv1learningprogressupsertpost) | **POST** /api/v1/learning/progress/upsert | Upsert Progress |
