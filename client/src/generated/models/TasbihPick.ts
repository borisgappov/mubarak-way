 ...
 * Tasbih pick model
 * @export
 * @interface TasbihPick
 */
export interface TasbihPick {
    /**
     * 
     * @type {string}
     * @memberof TasbihPick
...
/**
 * Check if a given object implements the TasbihPick interface.
 */
export function instanceOfTasbihPick(value: object): value is TasbihPick {
...
export function TasbihPickFromJSON(json: any): TasbihPick {
    return TasbihPickFromJSONTyped(json, false);
}

export function TasbihPickFromJSONTyped(json: any, ignoreDiscriminator: boolean): TasbihPick {
    if (json == null) {
        return json;
    }
    return {
...
export function TasbihPickToJSON(json: any): TasbihPick {
    return TasbihPickToJSONTyped(json, false);
}

export function TasbihPickToJSONTyped(value?: TasbihPick | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
